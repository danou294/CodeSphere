                ...
                <>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="hidden lg:flex items-center space-x-4">
                               <Link to="/contact" className="text-white hover:text-gray-300">Contact</Link>
                                ...
                                {currentUser ? (
                                    <>
                                        <Link to="/projectlist" className="text-white hover:text-gray-300">Mes Projets</Link>
                    ...
                    <Disclosure.Panel className={`lg:hidden transition-all ease-out duration-300 ${open ? 'block' : 'hidden'}`}>
                        <div className="px-4 pt-2 pb-3 space-y-1">
                            ...
                            {currentUser ? (
                                <>
                                    <Link to="/projectlist" className="block text-white hover:text-gray-300">Mes Projets</Link>
