...
function ForgotPasswordForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success("Un email de réinitialisation a été envoyé. Veuillez vérifier votre boîte de réception."); // Notification de succès
        } catch (error) {
            toast.error("Erreur lors de la demande de réinitialisation du mot de passe : " + error.message); // Notification d'erreur
        }
    };
