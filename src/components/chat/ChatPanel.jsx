            ...
            {!hasPaid && (
                <div className="absolute inset-0 bg-black bg-opacity-75 flex flex-col justify-center items-center z-10">
                    <div className="text-center p-6 bg-white text-gray-800 rounded-lg shadow-lg max-w-md">
                        <h2 className="text-2xl font-bold mb-4 text-blue-600">Accès Restreint</h2>
                        <p className="mb-6 text-lg">Débloquez l'accès complet à notre chatbot intelligent en souscrivant à l'offre premium. Profitez de fonctionnalités exclusives qui transformeront votre expérience utilisateur !</p>
                        <button 
