        ...
        <AuthProvider>
            <Router>
                ...
                <CookieConsent
                    ...
                    buttonStyle={{ color: "#fff", background: "#38a169", fontSize: "14px", padding: "10px 20px", borderRadius: "5px" }} // Style du bouton accepter
                    declineButtonStyle={{ color: "#fff", background: "#e53e3e", fontSize: "14px", padding: "10px 20px", borderRadius: "5px" }} // Style du bouton refuser
                    expires={150}
                    enableDeclineButton
                    onAccept={() => {
                ...
                >
                    <div className="flex items-center">
                        <FaCookieBite className="cookie-icon" /> {/* Ajout d'une icône sympa */}
                ...
                <div className="bg-gray-800 min-h-screen flex flex-col text-gray-200">
                    <Routes>
                        ...
                        <Route path="/projectlist" element={<PrivateRoute element={<ProjectList />} />} />
